...
function getCommandCategories() {
    ...
    bot.commands.developer.cache.forEach((cmd) => {
        if (
...
const command: SlashCommand = {
    data: new SlashCommandBuilder()
        .setName("help-dev")
        .setDescription("See help pages for all DEVELOPER commands.")
    ...
    help: {
        name: "help-dev",
        category: "utilities",
        description: "See help pages for all DEVELOPER commands.",
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        if (subcmdName === "categories") {
            ...
            helpEmbed.setTitle("Developer Help Menu - Categories");
        ...
        if (subcmdName === "category") {
            ...
            helpEmbed.setTitle(`Developer Help Menu - Category: ${category}`);

            if (category === "none") {
                bot.commands.developer.cache.forEach(
                    (cmd) =>
                        (!cmd.help.category ||
                            cmd.help.category === "" ||
        ...
        if (subcmdName === "command") {
            const commandName = interaction.options
                .getString("command")
                .toLowerCase();
            const command = bot.commands.developer.cache.find(
            ...
            helpEmbed.setTitle(
                `Developer Help Menu - Command: \`${commandName}\``,
            );
            helpEmbed.addFields(
